...
import { factIntros, facts, greetings, welcomeGreetings } from '@/data/phrases';
import { askAI, recordSpeech } from '@/functions/chat';
import {
  getLanguageName,
  getRandomPhrase,
  logMessage,
...
import { ChatConfig, LangCode } from '@/types/chat';
import { KEY_BG_IMAGE_NUMBER } from '@/constants/store';
